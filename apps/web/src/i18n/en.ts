...
export const en = {
  ...
  connection: {
    ...
    step: "Step",
    of: "of",
    stepScope: "Choose what CloudGuard can see",
    stepConsent: "Grant admin consent",
    stepAccess: "Grant read access",
    stepVerify: "Verify",
    stepSubscriptions: "Confirm subscriptions",
    scope: "Scope",
    ...
    accessIntro:
      "Run this at the scope you chose. Everything is filled in already \u2014 nothing to look up.",
    cloudShell: "Open Cloud Shell",
    copyScript: "Copy script",
    copied: "Copied",
    formatCli: "Cloud Shell",
    formatBicep: "Bicep",
    formatTerraform: "Terraform",
    waitingForAccess: "Waiting for the read access grant\u2026",
    verify: "Verify now",
    verifying: "Checking both grants\u2026",
    verified: "Connection verified",
    discovering: "Finding subscriptions\u2026",
    discovered: "subscriptions found",
    inScopeCount: "subscriptions in scope",
    inScope: "Scan this subscription",
    saveScope: "Save selection",
    done: "Done",
    rediscover: "Check for new subscriptions",
