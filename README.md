...
scanning and thirty-two AWS rules exist behind the same seam Azure sits behind
...
shows AWS greyed out with the reason until the seventeen-item checklist in
...
```
backend    1766 tests   pytest, ruff, mypy
